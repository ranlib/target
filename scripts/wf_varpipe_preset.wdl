...
workflow wf_varpipe_cdc {
  input {
    Array[File]+ read1
    Array[File]+ read2
    File reference = "/home/dbest/Analysis/varpipe4/references/NC_000962.3/NC_000962.3.fasta"
    File config = "/home/dbest/Analysis/varpipe4/configuration/snp_docker.config"
    ...
    String samplename
    String outdir = samplename
    String genome = "NC_000962.3"
    Boolean keep = false
    Boolean whole_genome = true
    Boolean verbose = false
    # fastq_screen
    Boolean run_fastq_screen = false
    File fastq_screen_configuration = "/home/dbest/Analysis/varpipe4/scripts/fastq_screen.conf"
    File fastq_screen_contaminants = "/home/dbest/Analysis/varpipe4/contamination/fastq_screen_contamination.tar.gz"
    #File fastq_screen_configuration = "gs://fc-718290db-e82f-4e78-9e82-d05f81c8f329/uploads/ERR552797_split_fastq/fastq_screen.conf"
    ...
    File clockwork_decontamination_metadata = "/home/dbest/Analysis/varpipe4/contamination/clockwork_decontamination_metadata.tsv"
    File clockwork_contaminants = "/home/dbest/Analysis/varpipe4/contamination/clockwork_contaminants.fa.gz"
    ...
    String? report
    File bed = "/home/dbest/Analysis/varpipe4/intervals/amp.bed"
    File json = "/home/dbest/Analysis/varpipe4/intervals/tbdb.dr.json"
    #File bed = "gs://fc-718290db-e82f-4e78-9e82-d05f81c8f329/uploads/ERR552797_split_fastq/amp.bed"
